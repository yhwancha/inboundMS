...
export default function OutboundExcelPage() {
  ...
  const handleExtractData = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error('Failed to save Outbound schedules')
      }
      ...
      setUploadStatus({
        type: "success",
        message: `${result.count}개의 Outbound 스케줄이 저장되었습니다!`
      })
  ...
  return (
    <div className="flex-1 space-y-6 p-8 pt-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-3xl font-bold tracking-tight">Outbound Schedule Excel Insert</h2>
